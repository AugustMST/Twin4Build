...
def get_signature_pattern():
    ...
    sp = SignaturePattern(ownedBy="SequenceControllerSystem", priority=10000)
    ...
    sp.add_edge(Exact(object=node1, subject=node5, predicate="hasProfile"))
...
class SequenceControllerPIRBCSystem(base.Controller):
    ...
    def __init__(self,
        ...
        self.rulebased_controller = systems.SuppliedAirTemperatureRBC(**get_object_properties(base_rulebased_controller))
