...
def get_signature_pattern():
    ...
    sp = SignaturePattern(ownedBy="BuildingSpaceNoSH1AdjBoundaryOutdoorFMUSystem_Tboundary", priority=180)
...
class BuildingSpaceNoSH1AdjBoundaryOutdoorFMUSystemTboundary(FMUComponent, base.BuildingSpace):
    """
